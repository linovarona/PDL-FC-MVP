...
|--------|-------------|----------|
| E001 | Servicio no disponible | Verificar que el servicio Windows esté en ejecución |
| E002 | Base de datos no accesible | Verificar conexión y permisos del archivo .db |
| E003 | Margen de utilidad excedido | Reducir margen al 30% máximo |
| E004 | Campos obligatorios faltantes | Completar todos los campos requeridos |
| E005 | Archivo Excel corrupto | Usar plantilla oficial |

### Anexo B: Referencias a Resoluciones

- **Resolución 148/2023**: Metodología para la elaboración de la ficha de costos y gastos
- **Resolución 209/2024**: Regulación del límite de ganancia (30% máximo)
- **Anexo 1**: Estructura detallada de costos directos e indirectos
- **Anexo 2**: Estructura de gastos generales
